...
const StyledWrapper = styled.div`
  ...
  */
  ...
  .container::after {
    ...
    position: absolute;
    inset: 0;
    z-index: 1; /* This pseudo-element is above the main pattern */
    /* No backdrop-filter in this new pattern, so removed */
    background-image: radial-gradient(
      ellipse 1.5px 2px at 1.5px 50%,
      #0000 0,
      #0000 90%,
      #000 100% /* Subtle dark dots */
    );
  ...
  .container {
    ...
    width: 100%;
    height: 100%;
    --c: #09f; /* Vibrant blue color for the "rain" */
